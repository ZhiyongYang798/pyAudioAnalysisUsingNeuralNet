...
def parse_arguments():
    ...
    trainClass = tasks.add_parser("trainClassifier", help="Train an SVM or KNN or NeuralNet classifier")
    trainClass.add_argument("-i", "--input", nargs="+", required=True, help="Input directories")
    trainClass.add_argument("--method", choices=["svm", "svm_rbf", "knn", "randomforest","gradientboosting","extratrees","neuralnet"], required=True, help="Classifier type")
