...
Command line:
For training
python audioAnalysis.py trainClassifier -i data/7/ data/9/ --method neuralnet -o NeuralModel/79New.ckpt

Here, the model name has to be modelname.ckpt.

For testing
python audioAnalysisRecordAlsa.py -recordAndClassifySegments 20 out.wav NeuralModel/79New.ckpt neuralnet
